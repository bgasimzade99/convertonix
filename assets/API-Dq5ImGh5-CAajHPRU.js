import{h as p,o as e,b as v,w as N,J as f,$ as h,g as m,s as g,F as b}from"./index-n2YMFGz9.js";import{o as y}from"./globe-DeFBzDbf-B3yKjJvh.js";/**
...
}`})]})]})}),e.jsx("section",{className:"sdks",children:e.jsxs("div",{className:"container",children:[e.jsx("h2",{className:"section-title",children:"SDKs & Libraries"}),e.jsxs("div",{className:"sdks-grid",children:[e.jsxs("div",{className:"sdk-card",children:[e.jsx(t,{size:32}),e.jsx("h3",{children:"JavaScript SDK"}),e.jsx("p",{children:"Official JavaScript SDK for Node.js and browsers"}),e.jsx("button",{className:"btn-outline",children:"View on GitHub"})]}),e.jsxs("div",{className:"sdk-card",children:[e.jsx(t,{size:32}),e.jsx("h3",{children:"Python SDK"}),e.jsx("p",{children:"Python library for easy integration"}),e.jsx("button",{className:"btn-outline",children:"View on PyPI"})]}),e.jsxs("div",{className:"sdk-card",children:[e.jsx(t,{size:32}),e.jsx("h3",{children:"PHP SDK"}),e.jsx("p",{children:"PHP library for server-side integration"}),e.jsx("button",{className:"btn-outline",children:"View on Packagist"})]})]})]})}),e.jsx(b,{})]})}export{A as default};
